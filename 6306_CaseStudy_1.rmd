...
#Remove spaces from around the state abbreviations
...
#Some of the values in the Style column are blank but not NA,
#so we will make them NA so they are treated equally
